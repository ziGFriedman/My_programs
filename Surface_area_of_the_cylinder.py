...
# Площадь бака представляет собой сумму площадей двух кругов (крышки и дна бака) и площади самой цилиндрической поверхности. Кроме того,
...
qty = int(qty) + 1     # требуется, если надо найти целое значение количества банок, ведь пол банки не купишь.
