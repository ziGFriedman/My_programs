...
# Вычислить продолжительность года на двух планетах по введенным радиусам их орбит и скорости
# движения по орбитам.
...
# Обычно радиус орбиты указывают в миллионах километров, а орбитальную скорость планеты - в
# километрах за секунду.
# Поэтому перед подстановкой в формулу радиуса его надо перевести в просто километры, умножив на
# 1 миллион. Полученная
# по формуле продолжительность года будет выражена в секундах, что неудобно. Чтобы перевести секунды
# в дни, надо
